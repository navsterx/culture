    ...
    <v-fade-transition>
      <div v-if="isLoaded">
        <v-sheet :color="company.brand_color" min-height="325"
          style="background: url('https://szesvbwpqmieaxppcjuh.supabase.co/storage/v1/object/public/images/io-studios/team.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center-top;">
